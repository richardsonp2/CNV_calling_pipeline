...
miscfolder="/home/mainframe/CNV_data/CNV_repo/penn_cnv_files"
DATASET="JAN_test"
PENNCNV="/home/mainframe/CNV_data/CNV_repo/penn_cnv_files/PennCNV-1.0.5/"
PERL="/home/mainframe/CNV_data/CNV_repo/penn_cnv_files/perl"
outpath="/home/mainframe/CNV_data/JAN_TEST_RMD"
#outpath="~/610_550/"
...
### Generate CNV calls
system(paste(PERL," ",PENNCNV,"detect_cnv.pl -test -hmm  ",miscfolder,"hhall.hmm -listfile PennCNV.list -pfb NCMH.GSA.hg19.pfb --confidence --log ",outpath,DATASET,".Calls.log --out ",outpath,DATASET,".Calls -gc NCMH.GSA.hg19.gcmodel",sep=""))

### Merge CNVs 
system(paste(PERL," ",PENNCNV,"clean_cnv.pl combineseg ",DATASET,".Calls -fraction 0.5 -signalfile NCMH.GSA.hg19.pfb --output ",outpath,DATASET,".Calls.Merged",sep=""))
...
cnv.qual=read.table(file="/home/mainframe/CNV_data/CNV_repo/tmp_scratch/FullData_test_JAN2026/output/qc_cnvs/FullData_test_JAN2026.qcsum",header=T,stringsAsFactors = F)
#cnv.include=read.table(paste(outpath,DATASET,".qcpass",sep=""),header=F)
cnv.include=read.table("/home/mainframe/CNV_data/CNV_repo/tmp_scratch/FullData_test_JAN2026/output/qc_cnvs/FullData_test_JAN2026.qcpass",header=F)
...
**Confidence score**: reflects the confidence that the CNV is not a false positive finding. CNVs with CONF\<10 are removed. **Density per probe \< 20kb**: This ensures adequate coverage of the CNV by probes.\
...
The locus specific criteria for calling neurodevelopmental CNVs were taken from [Kendall el al, 2019](https://jamanetwork.com/journals/jamapsychiatry/fullarticle/2730725). These criteria can be found at the end of this report. `r nrow(patho.criteria.met)` CNVs passed specific criteria meaning they may be ND CNVs:
...
17p13.3 del/dup (YWHAE): Exonic deletions, whole gene duplications\
17p13.3 del/dup (PAFAH1B1) Exonic deletions; whole gene duplications\
17p12: \>50% of critical region 17q11.2 del/dup (NF1): Size \>50% of critical region, affecting NF1\
