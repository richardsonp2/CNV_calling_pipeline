#!/bin/bash
#
# An implementation of PsyMed/10/SOP122/v1.1, section 6.4 onwards.
# A script to use the PennCNV software to call CNVs in data 
# generated by Illumina iScan array genotyping.
#
...
## 6.9.1 Overlapping and novel good CNVs
#
